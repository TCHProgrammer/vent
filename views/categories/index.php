    ...
    <div class="main-content__categories-item">
        ...
        <div class="item-content">
            <div class="wrap">
                    ...
                    <li>
                        <a href="#" class="tooltiped">
                            ...
                            <div class="tooltip">
                                ...
                                <button class="change" category_id="<?=$category->id;?>" brand_id="<?=$brand->id;?>" onclick="setElementBrandName(this);">
                                    <div class="icon">
                ...
                <a href="#" class="add-brand" category_id="<?=$category->id;?>" onclick="addCategoryBrand(this);">
                    <div class="icon">
